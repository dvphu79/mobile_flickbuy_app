...
extension CartItemByIndex on IsarCollection<CartItem> {
  Future<CartItem?> getByProductId(String productId) {
    return getByIndex(r'productId', [productId]);
  }

  CartItem? getByProductIdSync(String productId) {
  ...
  Future<List<CartItem?>> getAllByProductId(List<String> productIdValues) {
    final values = productIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'productId', values);
  }

  List<CartItem?> getAllByProductIdSync(List<String> productIdValues) {
    final values = productIdValues.map((e) => [e]).toList();
...
extension CartItemQueryProperty
  ...
  QueryBuilder<CartItem, String, QQueryOperations> productIdProperty() {
    return QueryBuilder.apply(this, (query) {
